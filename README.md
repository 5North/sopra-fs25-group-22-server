...
### Player Update (single)

{
  "messageType": "PLAYER_HAND_UPDATE",
  "data": {
    "userId": 100,
    "hand": [
      { "suit": "COPPE", "value": 3 },
...
### Select Capture (single)
{
  "messageType": "CAPTURE_OPTIONS",
  "data": {
    "userId": 100,
    "playedCard": { "suit": "COPPE", "value": 7 },
    "options": [
      [
        { "suit": "COPPE", "value": 3 },
        { "suit": "COPPE", "value": 4 }
...

{
  ...
  "data": {
    "userId": 100,
    "suggestedMove": {Play this and that
    }
  }
}
